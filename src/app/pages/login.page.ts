                ...
                <div class="card p-8">
                    <div class="space-y-6">
                        <div class="text-center">
                            <h3 class="text-xl font-semibold text-gray-900 mb-2">¡Bienvenido!</h3>
                            <p class="text-gray-600">Inicia sesión para comenzar a hacer tus predicciones</p>
                        </div>

                        <!-- Google Sign In Button -->
                        <button (click)="signInWithGoogle()" [disabled]="isLoading" class="btn-google w-full">
                            @if (isLoading) {
                                <svg
