...
@Component({
    ...
    imports: [DatePipe],
    template: `
        <div class="bg-gradient-to-r from-fifa-dark to-primary-900 text-white rounded-xl p-4 sm:p-6">
                    ...
                    <div class="flex justify-center gap-2 sm:gap-4">
                        @for (unit of timeUnits(); track unit.label) {
                            <div class="flex flex-col items-center">
                                <div
                                    class="bg-white/10 backdrop-blur rounded-lg px-3 py-2 sm:px-4 sm:py-3 min-w-[60px] sm:min-w-[80px]"
                                >
